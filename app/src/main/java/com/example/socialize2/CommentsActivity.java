...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView_comments = findViewById(R.id.recyclerciew_comments);
        ...
        post_comments.setOnClickListener(new View.OnClickListener() {
            ...
            private void Commentfeature(String username) {
                ...
                if(comment_post.isEmpty()){
                    ...
                    commentMap.put("comments",comment_post);
                    ...
                    postref.child(randomkey).updateChildren(commentMap).addOnCompleteListener(new OnCompleteListener() {
                               ...
                               if(task.isSuccessful()){
                                   ...
                                   Toast.makeText(CommentsActivity.this, "Comment Failed", Toast.LENGTH_SHORT).show();
                               }
                                }
                            })
        ...
        FirebaseRecyclerAdapter<Comments,CommentsViewHolder>firebaseRecyclerAdapter=
                new FirebaseRecyclerAdapter<Comments, CommentsViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull CommentsViewHolder holder, int position, @NonNull Comments model) {
                        holder.Commentsfeature(getApplication(),model.getComments(),model.getDate(),model.getTime(),model.getUsername());
                    }
